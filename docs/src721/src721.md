...
`SRC-721` is a Non-fungible Token Protocol on Bitcoin Stamps. It's almost backward compatible with SRC-20, but has new features and has no risk of loss assets by mistakenly spending them with UTXOs. It greatly supports high-quality pictures and complex metadata. It's arming to give Non-fungible tokens more possibilities and scalability.
...
```JSON
{
    ...
    "desc": "The first src-721. We love btc stamp.", //(string)description for the collection.[optional, default=""]
...
```
This allows src-721 admin transfer ownership to another. Only owner address can invoke "SETPROPERTY", "SETMETADATA" and "TRANSFEROWNERSHIP".

# SRC-721 Token Requirements

1. "p" must be “src-721” for src-721 standard, any change will make this transaction be invalid and it can't be tracked
...
8. Balance Calculations
    ...
    - If UTXO of the mint transaction was mistakenly spent, it doesn't do harm to your src-721 tokens.
...
# SRC-721 Token Example JSON Strings

```
🔺🔺 Invalid Examples: 🚫🚫

{"p": "src-721", "op": "deploy", "tick": "🙂We Love NFT", "max": "18446744073709551616", "limit": "1", "dec": "0", "owner": "bc1q34eaj4rz9yxupzxwza2epvt3qv2nvcc0ujqqpl", "rec": "bc1q7rwd4cgdvcmrxm27xfy6504jwkllge3dda04ww", "sym": "WLN", "price": "10000", "desc": "Art NFT collection for btc stamps", "wlf": "false"} ## "max" is over uint64_max
{"p": "src-721", "op": "deploy", "tick": "stamp hero🦄", "max": "10000", "limit": "5", "dec": "2", "owner": "bc1q34eaj4rz9yxupzxwza2epvt3qv2nvcc0ujqqpl", "rec": "bc1q7rwd4cgdvcmrxm27xfy6504jwkllge3dda04ww", "sym": "SH", "price": "10000", "desc": "Art NFT collection for btc stamps", "mintstart": "1706866958", "mintend": "1710317544", "wlf": "false"} ## "dec" must be 0 currently
{"p": "src-721", "op": "deploy", "tick": "🙂We Love NFT", "max": "18446744073709551616", "limit": "1", "dec": "0", "owner": "bc1q34eaj4rz9yxupzxwza2epvt3qv2nvcc0ujqqpl", "rec": "bc1q7rwd4cgdvcmrxm27xfy6504jwkllge3dda04ww", "sym": "WLN", "price": "10000", "desc": "Art NFT collection for btc stamps", "wlf": true, "disc": "20", "slf": false} ## "wlf" is true, but no "wll" be found
{"p": "src-721", "op": "deploy", "tick": "🙂We Love NFT", "max": "18446744073709551616", "limit": "1", "dec": "0", "owner": "bc1q34eaj4rz9yxupzxwza2epvt3qv2nvcc0ujqqpl", "rec": "bc1q7rwd4cgdvcmrxm27xfy6504jwkllge3dda04ww", "sym": "WLN", "price": "10000", "desc": "Art NFT collection for btc stamps", "wlf": "true", "wll": "https://daydream.io/whitelist/hello.xls", "disc": "20", "slf": false} ##not a csv format in "wll"
{"p": "src-721", "op": "mint", "hash": "0x38091b803f794e50dcc10a9091becaf4f65d", "amt": "1"}        ## not sha256 format hash
...
{"p": "src-721", "op": "deploy", "tick": "🙂We Love NFT", "max": "10000", "limit": "1", "dec": "0", "owner": "bc1q34eaj4rz9yxupzxwza2epvt3qv2nvcc0ujqqpl", "rec": "bc1q7rwd4cgdvcmrxm27xfy6504jwkllge3dda04ww", "sym": "WLN", "price": "10000", "desc": "Art NFT collection for btc stamps", "wlf": "false"}
{"p": "src-721", "op": "deploy", "tick": "🙂We Love NFT", "max": "18446744073709551616", "limit": "1", "dec": "0", "owner": "bc1q34eaj4rz9yxupzxwza2epvt3qv2nvcc0ujqqpl", "rec": "bc1q7rwd4cgdvcmrxm27xfy6504jwkllge3dda04ww", "sym": "WLN", "price": "10000", "desc": "Art NFT collection for btc stamps", "wlf": "true", "wll": "https://daydream.io/whitelist/hello.csv", "disc": "20", "slf": false}
{"p": "src-721", "op": "mint", "hash": "0xcad42b6bcbcbff165f862df442280c07f73ad263bd28b6fd60722a8ae7a9318b", "amt": "1"}
{
    "p": "src721",
    "op": "mint",
