...
The TRANSFER mechanism must be performed by the address that holds the balance of an SRC-20 mint as it acts as a means of authentication. The transfer functionality specifications are under review and will be published as soon as possible. Right now to protect user funds this function has been suspended.
